export const hazards = [
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Segmental Joints – Narrow In-Situ Mortar",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Segmental Joints – Wide In-situ Mortar ",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Construction Joints Intersection Ducts and Tendons ",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Tendons Grouped Together in One or Two Ducts Rather Than Each Tendon Protected in Its Own Duct",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Tendons Located Close to The Upper Surface of The Deck Where Failure of The Deck Waterproofing May Led to Corrosion",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Use of Metal Spacers to Separate Post-Tensioning Wires",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Tendons Protected Only by Mortar/Concrete Surround",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Unprotected Anchorages on External Faces of Beams",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Anchorages Concealed Within Joints or On Upper Surfaces of Decks",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Grout Tubes Exposed in The Top of The Deck Slab",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Absence of An Adequate Drainage System",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Absent Or Old Deck Waterproofing System",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Absent of Deck Joint Seals",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Low Cover to Reinforcement",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Admixtures Containing Chlorides Used in Concrete or Grout",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Inadequate Longitudinal or Shear Reinforcement (As Determined by Assessment and Observation of Cracks)",
    ...
    {
    hazardCategory: "Vulnerable Details and Material Hazards", 
    hazardName: "Longitudinal Post-Tensioned Tendons with Sagging and Hogging Profiles ",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName: "Cracking In Prestressed Concrete Sections",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Cracks And Potholes on Carriageway Surface",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Surface Ponding on The Deck",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Blocked Drainage Systems",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Water Trapped in Boxes and Other Structure Voids",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Damaged Or Missing Deck Joint Seals",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Water Leaks and Staining on Soffit and At Joints and Cracks",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Excessive Deflection // Differential Vertical Deflection",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Spalling Due to Corrosion and/or Freeze/Thaw Action",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Spalling Due to Stress Concentrations",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Visual Evidence of Reinforcement Corrosion",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Adverse Half-Cell and/or Chloride Test Results",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Cracks, Leaks and Stains to Movement/Expansion Joints",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Deterioration And Damage to Bearings",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Unexpected Bearing Movement/Rotation or Failure to Move/Rotate as Expected",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "Incorrect Location of Ducts",
    ...
    {
    hazardCategory: "Condition Hazards - External",
    hazardName:  "High Sulfate Content",
    ...
    // CONDITION HAZARDS INTERNAL (PT)

    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Corrosion Of Ducts",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Perforation Of Ducts",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Presence Of Water in Ducts",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Cracked Or Shattered Grout",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "High Chloride Content in Grout",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Low Cement Content in Grout ",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Incorrect Type or Size",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Corrosion Of Tendons",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Fracture Of Wires or Tendons",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Voids At Anchorages",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Moisture/Water Present at Anchorages",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "High Chloride Content in Anchorage Capping Concrete",
    ...
    {
    hazardCategory: "Condition Hazards - Internal (Post-Tensioning)",
    hazardName: "Corrosion Of Anchorages",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName: "Grouting Problems",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Tensioning Problems",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Failure To Maintain Water Management Systems",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Changes In Highway Cross-Section",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Maintenance Actions Identified in Previous Inspection Reports Have Not Been Completed",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Use Of De-Icing Salts",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Proximity To Chemical Works",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Proximity To the Sea",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Inadequate Principal/General/Special Inspections",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Previous PTSI Was Incomplete/Inadequate",
    ...
    {
    hazardCategory: "History Hazards",
    hazardName:  "Recommendations From Previous PTSI Have Not Been Implemented",
    ...
    {
    hazardCategory: "Assessment Hazards",
    hazardName:"Structure Has Not Been Assessed for Current Condition, Assessment Standards or Operation Loading",
    ...
    {
    hazardCategory: "Assessment Hazards",
    hazardName: "Structure Has Been Assessed as Substandard",
    ...
    {
    hazardCategory: "Assessment Hazards",
    hazardName:  "Structure Has Not Been Assessed for Sensitivity to Loss of Prestress",
    ...
    {
    hazardCategory: "Assessment Hazards",
    hazardName:  "Assessment Has Not Identified and Considered All Possible Failure Modes",
